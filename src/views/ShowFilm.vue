<template>
 <div class="mt-5 mb-5" v-if="dataFilm != null">
   <div class="embed-responsive embed-responsive-16by9 mb-5" v-if="this.baFilm != null">
    <iframe  class="embed-responsive-item" width="160%" height="315" v-bind:src="this.youtubeUrl+this.baFilm.results[0].key" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
   </div>
   <div v-else>
      <p>Video d'annonce non disponible</p>
   </div>
   <div class="row">
    <img  class="col-md-4" v-bind:src="baseImg+posterFilm" alt="">
